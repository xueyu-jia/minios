...
typedef volatile struct tagHBA_MEM {
    ...
    HBA_PORT ports[32]; // max:32 ports
} HBA_MEM;
...
#define HBA_Port_ERROR \
    (HBA_PxIS_TFES | HBA_PxIS_HBFS | HBA_PxIS_HBDS | HBA_PxIS_IFS | HBA_PxIS_OFS | HBA_PxIS_UFS)
// 表示该端口数据传输完成
#define HBA_Port_COMPLETED \
    (HBA_PxIS_DHRS | HBA_PxIS_DSS | HBA_PxIS_PSS | HBA_PxIS_SDBS | HBA_PxIS_SG_DONE)
/*****************************************************************************************/
...
#define ahci_active() (&ahci_info[0])
#define ahci_hba() (ahci_active()->hba_mmio)
