...
#include <minios/msg.h> //added by yingchi 2022.01.07
#include <minios/proc.h>
#include <minios/signal.h> //modified by mingxuan 2021-8-7
...
// //edit by visual 2016.5.9   //deleted by mingxuan 2021-8-21
// PUBLIC void* sys_malloc(int size);			//edit by visual
// 2016.5.9
// //deleted by zhenhao 2023.3.5

// PUBLIC void* sys_malloc_4k();				//edit by visual
// 2016.5.9 PUBLIC u32 sys_malloc_4k(u32 vaddr);      //modified by mingxuan
// 2021-3-25
u32 sys_malloc_4k(); // modified by mingxuan 2021-8-13
...
int sys_pthread_create();     // add by visual 2016.4.11
pthread_t sys_pthread_self(); // added by ZengHao & MaLinhan 21.12.23

void sys_pthread_exit(); // added by dongzhangqi 2023.5.4
int sys_pthread_join();

/* pthread_mutex.c pthread_cond.c */
int sys_pthread_mutex_init();     // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_mutex_destroy();  // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_mutex_lock();     // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_mutex_unlock();   // added by ZengHao & MaLinhan
                                  // 2021.12.23
int sys_pthread_mutex_trylock();  // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_cond_init();      // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_cond_wait();      // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_cond_timewait();  // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_cond_signal();    // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_cond_broadcast(); // added by ZengHao & MaLinhan 2021.12.23
int sys_pthread_cond_destroy();   // added by ZengHao & MaLinhan
                                  // 2021.12.23
...
/* shm.c */
int sys_shmget();             // added by xiaofeng 2021-9-8
void* sys_shmat();            // added by xiaofeng 2021-9-8
void sys_shmdt();             // added by xiaofeng 2021-9-8
struct ipc_shm* sys_shmctl(); // added by xiaofeng 2021-9-8
void* sys_shmmemcpy();        // added by xiaofeng 2021-9-8
...
/*proc.c*/
void sys_nice();   // lzq
void sys_set_rt(); // turn_rt is true,process was change to rt process;
