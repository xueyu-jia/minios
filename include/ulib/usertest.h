...
#include <msg.h>     // IWYU pragma: export
#include <pthread.h> // IWYU pragma: export
#include <signal.h>  // IWYU pragma: export
#include <stdio.h>   // IWYU pragma: export
#include <string.h>  // IWYU pragma: export
#include <syscall.h> // IWYU pragma: export
#include <ushm.h>    // IWYU pragma: export
...
#define SAFE_OPEN(filename, oflags) safe_open(__FILE__, __LINE__, NULL, (filename), (oflags))

#define SAFE_CLOSE(fd) safe_close(__FILE__, __LINE__, fd)

#define SAFE_WRITE(fd, buf, nbytes) safe_write(__FILE__, __LINE__, fd, buf, nbytes)

#define SAFE_READ(fd, buf, nbytes) safe_read(__FILE__, __LINE__, fd, buf, nbytes)
...
int safe_read(const char *file, const int lineno, int fd, void *buf, int nbytes);
