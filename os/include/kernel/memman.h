...
// pte_attribute); PUBLIC int ker_umalloc_4k(u32 AddrLin, u32 pid, u32
// pte_attribute); PUBLIC int ker_ufree_4k(u32 pid, u32 AddrLin);
...
void free_vmas(PROCESS* p_proc, LIN_MEMMAP* mmap, struct vmem_area* start,
               struct vmem_area* last);
