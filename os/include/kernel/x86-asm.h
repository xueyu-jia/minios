...
ASMCALL void lcr0(u32 val) { __asm__ volatile("movl %0, %%cr0" : : "r"(val)); }
...
ASMCALL void lcr3(u32 val) { __asm__ volatile("movl %0, %%cr3" : : "r"(val)); }
...
ASMCALL void lcr4(u32 val) { __asm__ volatile("movl %0, %%cr4" : : "r"(val)); }
...
ASMCALL void clear_dir_flag() { __asm__ volatile("cld"); }

ASMCALL void disable_int() { __asm__ volatile("cli"); }

ASMCALL void enable_int() { __asm__ volatile("sti"); }

ASMCALL void halt() { __asm__ volatile("hlt"); }
