...
typedef struct tagHBA_CMD_HEADER
{
	...
	// DW2, 3
	u32 ctba;		// Command table descriptor base addressa,ligned to a 128-byte cache line
...
typedef struct tagHBA_PRDT_ENTRY
{
	...
	u32 dbau;		// Data base address upper 32 bits, indicated by bit 0 being reserved.
