...
// 	//buf = (PBYTE)K_PHY2LIN(do_kmalloc(Bytes_Per_Sector*sizeof(BYTE)));	//modified by mingxuan 2021-3-25
// 	buf = (PBYTE)kern_kmalloc(Bytes_Per_Sector*sizeof(BYTE));	//modified by mingxuan 2021-8-16
...
// 	}while(1);
// 	//sys_free(buf);
// 	//do_kfree(K_LIN2PHY(buf));	//modified by mingxuan 2021-3-25
// 	kern_kfree(buf);	//modified by mingxuan 2021-8-17
...
// 	state=ReadRecord(psb, parentCluster,name,&record,&sectorIndex,&off_in_sector);
// 	if(state!=OK)
// 	{
// 		return state;
// 	}
...
// 	//clusters = (PDWORD)K_PHY2LIN(do_kmalloc(n*sizeof(DWORD)));	//modified by mingxuan 2021-3-25
// 	clusters = (PDWORD)kern_kmalloc(n*sizeof(DWORD));	//modified by mingxuan 2021-8-16
// 	if(clusters==NULL)
// 	{
// 		return SYSERROR;
// 	}
...
// 	//sys_free(clusters);
// 	//do_kfree(K_LIN2PHY(clusters));	//modified by mingxuan 2021-3-25
// 	kern_kfree(clusters);	//modified by mingxuan 2021-8-17
// 	return OK;
// }
...
// 	//clusters = (PDWORD)K_PHY2LIN(do_kmalloc((num+1)*sizeof(DWORD)));	//modified by mingxuan 2021-3-25
// 	clusters = (PDWORD)kern_kmalloc((num+1)*sizeof(DWORD));	//modified by mingxuan 2021-8-16
// 	if(clusters==NULL)
// 	{
// 		return SYSERROR;
// 	}
...
// 	//last=first+8;
// 	last=first+Sectors_Per_Cluster;	//modified by mingxuan 2021-2-8
	
// 	for(sectorIndex=first;sectorIndex<last;sectorIndex++)
// 	{
// 		//WriteSector(psb, buf,sectorIndex);
// 		WriteSector(psb->sb_dev, buf,sectorIndex);	//modified by mingxuan 2021-2-8
// 	}
// }

// // int strcmp(const char * s1, const char *s2) moved to klib
// // {
