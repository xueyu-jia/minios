 ...
 *======================================================================*/
PUBLIC void switch_pde() { cr3_ready = p_proc_current->task.cr3; }
 ...
 *======================================================================*/
PRIVATE inline u32 get_pde_index(u32 AddrLin) {  //由 线性地址 得到 页目录项编号
...
PRIVATE inline u32 get_pte_index(u32 AddrLin) {  //由 线性地址 得到 页表项编号
  return (
      ((AddrLin)&0x003FFFFF) >>
      12);  //中间10位A21~A12,0x3FFFFF = 0000 0000 0011 1111 1111 1111 1111 1111
}
...
PRIVATE inline u32 get_page_phy_addr_nopid(
    u32 PageTblPhyAddr,  //页表物理地址				//edit by visual
                         // 2016.5.19
    u32 AddrLin)         //线性地址
{                        //获取该线性地址对应的物理页物理地址
