...
PUBLIC int kern_get_pid() { return p_proc_current->task.pid; }
...
PUBLIC void do_get_proc_msg(proc_msg* msg) { kern_get_proc_msg(msg); }
PUBLIC void sys_get_proc_msg() { do_get_proc_msg((proc_msg*)get_arg(1)); }
...
*/
PUBLIC void wakeup_for_sem(void* chan) { wakeup(chan); }
