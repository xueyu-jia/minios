...
#define EFLAGS_IMPL(N, x, ...) MH_EXPAND(MH_CONCAT(EFLAGS_IMPL, N)(x, __VA_ARGS__))
#define EFLAGS_WRAPPER(...) MH_EXPAND(EFLAGS_IMPL(MH_EXPAND(MH_NARG(__VA_ARGS__)), __VA_ARGS__))
