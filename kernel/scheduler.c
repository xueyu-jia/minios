...
static sched_entity* get_current_entity(PROCESS* current_proc);
...
MAYBE_UNUSED static inline PROCESS* rq_front_p() {
    return rq_front()->p_process;
}
MAYBE_UNUSED static inline PROCESS* rq_back_p() {
...
MAYBE_UNUSED static inline PROCESS* rt_rq_front_p() {
    return rt_rq_front()->p_process;
}
MAYBE_UNUSED static inline PROCESS* rt_rq_back_p() {
