...
int pthread_mutex_init (pthread_mutex_t *mutex, pthread_mutexattr_t *mutexattr);//added by ZengHao & MaLinhan 2021.12.23
...
int pthread_cond_init(pthread_cond_t *cond,const pthread_condattr_t *cond_attr);//added by ZengHao & MaLinhan 2021.12.23
int pthread_cond_wait(pthread_cond_t *cond,pthread_mutex_t *mutex);//added by ZengHao & MaLinhan 2021.12.23
int pthread_cond_timewait(pthread_cond_t *cond,pthread_mutex_t *mutex,int timeout);//added by ZengHao & MaLinhan 2021.12.23
