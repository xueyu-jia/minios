...
#define NR_SYS_CALL \
    59 // modified by mingxuan 2021-3-25
...
#define PageTblNumAddr \
    0x500 // 页表数量放在这个位置,必须与load.inc中一致
          //  add by visual 2016.5.11
// #define KernelPageTblAddr	0x200000
////内核页表物理地址，必须与load.inc中一致			add by visual
// 2016.5.17
#define KernelPageTblAddr \
    0x100000 // 内核页表物理地址，必须与load.inc中一致			add by
             //  wang 2021.4.22
...
#define K_PHY2LIN(x) \
    ((x) + 0xC0000000) // 内核中物理地址转线性地址		//add by visual
                       //  2016.5.10
