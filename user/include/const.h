...
#define NR_SYS_CALL       30	//modified by mingxuan 2021-3-25	删除了4个系统调用接口：kmalloc、kmalloc_4k、malloc和free
...
#define KernelPageTblAddr	0x100000 //内核页表物理地址，必须与load.inc中一致			add by wang 2021.4.22
